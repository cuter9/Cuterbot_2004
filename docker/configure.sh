...
elif [[ "$L4T_VERSION" == "32.7.1" ]] || [[ "$L4T_VERSION" == "32.7.4" ]] || [[ "$L4T_VERSION" == "32.7.5" ]]
then
...
echo "CUTERBOT_DOCKER_REMOTE=$CUTERBOT_DOCKER_REMOTE"
echo "L4T_RELEASE=$L4T_RELEASE"
echo "CUTERBOT_IMAGES_TAG=$CUTERBOT_IMAGES_TAG"
echo "HOME=$HOME"
